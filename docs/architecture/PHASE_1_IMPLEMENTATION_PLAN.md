...
| 3 | Add the track peak-energy reference to the cache header as immutable metadata (D-4), and define where a pre-publication whole-track pass sits relative to §17.1's stage order. | `audio:analysis`, `audio:cache` format |
